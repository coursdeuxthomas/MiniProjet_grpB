...
public:
    // Constructeur
    CarteDeRevision(const string& recto = "a", const string& verso = "a") : recto_(recto), verso_(verso), facteur_difficulte_(1.0), score_difficulte_(1), serie_(0), date_revision_("2000-01-01") {}
